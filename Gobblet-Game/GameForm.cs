...
namespace Gobblet_Game
{
    public partial class GameForm : Form
    {
        ...
        private Move PlayAI()
        {
            ...
            int x = gameState.getBestMove(5,0);
        ...
        private int HandleExternalPiece(PictureBox previousPictureBox, PictureBox currentPictureBox, Cell currentCell)
        {

            if (previousPictureBox.Tag is not Stack<Piece> pieces) return 0;
